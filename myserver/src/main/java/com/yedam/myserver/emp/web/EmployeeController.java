...
public class EmployeeController {
	...
	public Employee selectDepartment(Employee bean) {
		return employeeDao.findEmployee(bean);
	}
	...
	public  List<Employee> deleteEmployees(@RequestBody List<Employee> bean, HttpServletResponse response) {
		for(Employee emp : bean) {
